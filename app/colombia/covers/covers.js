...
export default function CoversScreen() {
    ...
    const loadData = async () => {
      ...
      if (storedDb) {
        ...
        try {
          ...
          if (themeChanged) {
            try {
              await AsyncStorage.setItem("colombiaDB", JSON.stringify(parsed));
            } catch (e) {
              console.warn(
                "No se pudo sobrescribir colombiaDB tras corrección de POSTER THEME:",
                e,
              );
            }
          }
  ...
  const saveObservation = async () => {
    if (selectedItem) {
      ...
      setData(newData);
      await AsyncStorage.setItem("colombiaDB", JSON.stringify(newData));
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        <Link href="/colombia/colombia" style={styles.link}>
          Volver a Años
        </Link>
      </View>
    </SafeAreaView>
